<nav class="bg-gray-800" x-data="{ open: false }">
        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <a href="/" class="flex-shrink-0 flex items-center">
                    <img class="block lg:hidden h-8 w-auto" src="/img/rrsistemash_logo.svg" alt="Workflow">
                    <img class="hidden lg:block h-8 w-auto" src="/img/rrsistemas-logo.png" alt="Workflow">
                </a>
            ...
            @auth
            {{-- Boton de notificacion y Profile dropdown--}}
    ...
    <!-- Menu Movil show/hide based on menu state. -->
